...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #008C62;" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="{{ asset('assets/img/logo.png') }}" alt="..." /></a>
                ...
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    @if (Auth::check())
                        @if (Auth::user()->type == 'administrator')
                            <li class="nav-item"><a class="nav-link" href="{{ route('employees.index') }}">Manage
                                    Employees</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('leaveTypes.index') }}">Manage Leave
                                    Types</a></li>
                        ...
                        @elseif (Auth::user()->type == 'employee')
                            <li class="nav-item"><a class="nav-link"
                                    href="{{ route('employee.request.create', Auth::user()->id) }}">Submit Request</a>
                            </li>
